...
const VERSION="v18.6 S9 NÖBET MODU - TRADE BULANA KADAR";
...
async function runScan(opts={watch:false}){
  ...
  setBar(0);
  await loadMarket();await loadFx();await getUniverse();
